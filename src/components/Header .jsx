            ...
            <div className="desktop-header">
                ...
                <div className="desktop-header__options">
                    <div className="desktop-header__menu-bar">
                        <button className="menu-bar__dropdown">TC GAME</button>
                    ...
                    <div className="desktop-header__menu-bar">
                        <button className="menu-bar__dropdown">SOCIAL</button>
                        <div className="dropdown-content">
                            <span>TUTORIAL</span>
                ...
                <div className="desktop-header__login">
                    <img id="logo__login" alt="error"
                        src="https://www.flaticon.es/svg/static/icons/svg/748/748137.svg" />
                    <span className="login__enter">LOGIN</span>
                </div>
                <div className="desktop-header__logotgc">
                    <img id="logo__tgc" alt="error"
